import { Pagination, PaginationInfo, RowsPerPageSelect } from "@/shared/components/ui/pagination"
import { cn } from "@/shared/utils/cn"

import type { TableProps } from "../type/types"
...
function TablePagination({
  ...
  return (
    ...
    >
      {showInfo && (
        <PaginationInfo page={table.page} rowsPerPage={table.rowsPerPage} totalRows={totalRows} />
      )}
      ...
      <div className="flex flex-1 items-center justify-between gap-4 sm:justify-end">
        ...
        <Pagination page={table.page} totalPages={totalPages} onPageChange={handlePageChange} />
      </div>
    </div>
  )
}
